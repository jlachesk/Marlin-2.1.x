...
#define FW_TEST_TAG "-tmc-v1.0"
#ifndef FW_TEST_TAG
	#define FW_TEST_TAG ""
#endif
#define SHORT_BUILD_VERSION       "0.6.0" FW_TEST_TAG "-Marlin2.x" 
#define DEFAULT_MACHINE_NAME      "LONGER 3D Printer"   // override by  CUSTOM_MACHINE_NAME if any
#define SOURCE_CODE_URL           "https://github.com/jlachesk/skynetlab/tree/main/makerlab/firmware/LK5Pro-LGT-Marlin2.x"
#define STRING_DISTRIBUTION_DATE  "2024-10-16"
#define WEBSITE_URL               "octoprint.skynetlab.casa"
...
#define STRING_CONFIG_H_AUTHOR "Longer3D, Hobi, tpruvot, jlachesk"  // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 212.18
  #define DEFAULT_bedKi 41.78
  #define DEFAULT_bedKd 718.45
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET_X -50
#define NOZZLE_TO_PROBE_OFFSET_Y -12
#define NOZZLE_TO_PROBE_OFFSET { NOZZLE_TO_PROBE_OFFSET_X, NOZZLE_TO_PROBE_OFFSET_Y, -2.75 }
...
// If using TITAN (or similar) invert Extruder Stepper
#define INVERT_E0_DIR true

// If using Stock, BMG (or similar), do not invert Extruder Stepper
