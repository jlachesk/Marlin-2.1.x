...
#if ANY(ULTIPANEL, EXTENSIBLE_UI)
...
#if HAS_GRAPHICAL_LCD && ANY(SDSUPPORT, LCD_SET_PROGRESS_MANUALLY)
...
#if HAS_CHARACTER_LCD && ANY(SDSUPPORT, LCD_SET_PROGRESS_MANUALLY)
...
//
  ...
  #if ANY(DGUS_LCD_UI_FYSETC, DGUS_LCD_UI_HIPRECY)
 ...
 */
  ...
  //#define MIN_PROBE_EDGE_RIGHT 27
  //#define MIN_PROBE_EDGE_FRONT 12
  //#define MIN_PROBE_EDGE_BACK 12
#endif
  ...
  #define MESH_MAX_X (X_MAX_POS + NOZZLE_TO_PROBE_OFFSET_X - 1)
  #define MESH_MAX_Y (Y_MAX_POS + NOZZLE_TO_PROBE_OFFSET_Y - 1)
  //Manually define these based on probe locations
  //#define MESH_MIN_X 10
  //#define MESH_MAX_X 285
  //#define MESH_MIN_Y 40
  //#define MESH_MAX_Y 315
#endif
